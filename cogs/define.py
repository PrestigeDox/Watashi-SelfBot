...
class Define:
    ...
    async def define(self, ctx, word: str):
        ...
        try:
            defn = soup.find('div', attrs={'data-dobid': 'dfn'***REMOVED***).text
            pos = soup.find('div', attrs={'class': 'lr_dct_sf_h'***REMOVED***).span.text
            syn_list = [x.text for x in soup.find_all('span', attrs={'class': '_Yht'***REMOVED***)]
        ...
        em.add_field(name='Definition', value=f'_{self.parts_of_speech[pos]***REMOVED***_, {defn***REMOVED***')
